  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        <button type="Submit" className="mb-6 w-full text-center px-7 py-3 bg-blue-600 text-white rounded font-medium text-sm uppercase shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg trasition duration-150 ease-in-out" >
          Create Listing
        </button>
      </form>
    </main>
